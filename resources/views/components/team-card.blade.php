<main>
    <div class="card bg-transparent border-0 text-center">
        <div class="card-img">
            ...
            @if ($member->fb_url != '' || $member->tw_url != '' || $member->in_url != '' || $member->yt_url != '' || $member->tt_url != '')
                <ul class="card-social list-inline">
                    ...
                    @endif      
                    @if ($member->yt_url != '')
                        <li class="list-inline-item"><a class="instagram" target="_blank" href="{{ $member->yt_url }}"><i class="fab fa-youtube"></i></a></li>
                    @endif
                    @if ($member->tt_url != '')
                        <li class="list-inline-item"><a class="instagram" target="_blank" href="{{ $member->tt_url }}"><i class="fab fa-tiktok"></i></a></li>
                    @endif
                </ul>
            @endif
        </div>
