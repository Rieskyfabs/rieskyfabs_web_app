...
<head>
	<meta charset="utf-8">
	<title>{{ $title ?? 'Rieskyfabs Web App' }}</title>
	...
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			<a class="navbar-brand" wire:navigate href="{{ route('home') }}">
				<img loading="prelaod" decoding="async" class="img-fluid" width="160" src="{{ asset('front/images/logo.png')}}" alt="Rieskyfabs Logo">
			</a>
		...
		<div class="row justify-content-between">
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="list-inline-item me-4"><a class="text-black" wire:navigate href="{{ route("page",4) }}">Privacy Policy</a></li>
						<li class="list-inline-item me-4"><a class="text-black" wire:navigate href="{{ route("page",3) }}">Terms &amp; Conditions</a></li>
					</ul>
				</div>
			</div>			
		</div>
